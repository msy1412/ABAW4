...
from utils.train import train_iter_FERAU
...
def parse_arguments():
    ...
    parser.add_argument('--AU_cls', type=int, default=16)
    ...
    parser.add_argument('--dataset', type=str, default='ABAW4+Openface')
...
def main():
    ...
    train_iter_FERAU(train_loader,val_loader,model,criterion, optimizer,warmup_scheduler,
                    all_iteration, warmup_iter,scheduler, args,AU_RATIO=0.5)
